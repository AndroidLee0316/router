...
-keep class com.alibaba.android.arouter.**{*;}
 -keep class com.pasc.lib.router.Navigator{
    public <methods>;
 }
 -keep class com.pasc.lib.router.aspect.**{*;}

  -keep class com.pasc.lib.router.Navigator$*{
     public <methods>;
  }
-keep class com.pasc.lib.router.RouterGraph{
     public <methods>;
}
-keep class com.pasc.lib.router.param.**{*;}
-keep class com.pasc.lib.router.BaseJumper{
    public <methods>;
 }
  -keep class com.pasc.lib.router.BaseJumper$*{
     *;
  }
 -keep class com.pasc.lib.router.RouterManager{
     public <methods>;
  }
-keep class com.pasc.lib.router.IServiceHandler{*;}
-keep class com.pasc.lib.router.ServiceProtocol{*;}
-keep class com.pasc.lib.router.ServiceHandlerCallback{*;}

 -keep class com.pasc.lib.router.interceptor.**{*;}
